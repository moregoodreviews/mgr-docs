---
description: >-
  Display a QR code on a tablet or screen so customers can scan and leave
  ratings and feedback on their phone.
...
* **Locations section** – If you've [assigned locations](locations.md) to your review page, each location row has a **Kiosk Page** button. Click it to open the kiosk page with that location pre-selected, so reviews are attributed to the correct store or branch.
...
4. The review page opens on their phone. They select a rating, leave feedback, or follow links to Google or other review sites—depending on your [Settings](settings.md), [Links](links.md), and [Redirects](redirects.md).
5. After submitting, they see your [Success Page](success.md) on their phone.

Reviews and ratings from the kiosk are stored in your project and appear in your [Reviews](platform/projects/reviews.md) and [Analytics](platform/projects/analytics.md).
