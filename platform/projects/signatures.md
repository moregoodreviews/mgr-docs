...
You can request reviews by embedding the ratings into your email signature. In your project settings, go to the Signature page, [here](https://moregoodreviews.com/settings/signature). You can customize the HTML signature to suit your needs. Once ready, copy and paste either the raw HTML code or the complete signature into your preferred email program.
