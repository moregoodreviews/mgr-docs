...
Your project has a secret API key that you can use to authenticate your requests. You can find your project’s API key here: [https://moregoodreviews.com/settings/developers](https://moregoodreviews.com/settings/developers)
